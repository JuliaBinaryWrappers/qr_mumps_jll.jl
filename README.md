# `qr_mumps_jll.jl` (v3.1.1+0)

[![deps](https://juliahub.com/docs/qr_mumps_jll/deps.svg)](https://juliahub.com/ui/Packages/General/qr_mumps_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e4e122532aba8e930cedb4b82d36caecd8aab831/Q/qr_mumps/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://gitlab.com/qr_mumps/qr_mumps.git (revision: `3ed9c3a42c7bb620c90c9c816097654c5d2cfc60`)
